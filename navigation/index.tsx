...
import { OpportunitiesTab } from "../screens/OpportunitiesTab";
import {
  RootStackParamList,
  RootTabParamList,
  RootTabScreenProps,
  ...
  return (
    <BottomTab.Navigator
      ...
      screenOptions={{
        ...
        tabBarInactiveTintColor: Colors[colorScheme].inativeTint,
        headerShown: false,
    ...
    >
      ...
      <BottomTab.Screen
        ...
        options={{
          title: "",
          tabBarIcon: ({ color }) => (
            <Ionicons name="md-stats-chart" size={32} color={color} />
          ),
        }}
      />
    </BottomTab.Navigator>
